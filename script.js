...
// IN-UPDATE: Para ipakita ang Description pag-click ng Image
function openProductView(index) {
    ...
    document.getElementById('viewDesc').innerText = item.description || "No additional notes for this item.";
