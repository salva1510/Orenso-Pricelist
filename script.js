...
// IN-UPDATE: Pinakita na ang Price per Piece at Price per Box sa Product Card
            ...
            <div class="product-card">
                ...
                <div onclick="openProductView(${index})" style="cursor:pointer; flex-grow:1;">
                    ...
                    <div style="margin-bottom: 8px;">
                        <div class="price-tag" style="font-size: 13px; color: #28a745;">₱${(item.pricePiece || 0).toLocaleString()} / pc</div>
                        <div class="price-tag" style="font-size: 12px; color: #1a73e8;">₱${(item.priceBox || 0).toLocaleString()} / box</div>
                    </div>
                </div>
...
// IN-UPDATE: May controls na para sa + at - sa loob ng Basket
