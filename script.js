...
document.addEventListener('DOMContentLoaded', () => {
    ...
    loadData();
    setupSwipe(); // Initialize swipe listeners
});
...
// UPDATE: Slider is now clickable to open details
...
function handleSwipe() {
    if (touchEndX < touchStartX - 50) moveSlider(1); // Swipe Left -> Next
    if (touchEndX > touchStartX + 50) moveSlider(-1); // Swipe Right -> Prev
}
