...
function displayItems(items) {
    ...
    items.forEach((item, index) => {
        ...
        tableBody.innerHTML += `
            <tr>
                <td><img src="${item.image}" class="product-img" onclick="openProductView(${index})" onerror="this.src='https://via.placeholder.com/150?text=No+Image'"></td>
...
function applyAdminUI() {
    ...
    statusText.style.color = "#2ecc71"; // Green indicator
